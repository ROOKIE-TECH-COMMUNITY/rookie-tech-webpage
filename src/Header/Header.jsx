...
export default function Header({backgroundColor, buttonType}) {
  return (
    <header className={`block bg-${backgroundColor} w-full shadow-md sticky left-0 top-0 z-50`}>
      <div className={`navigation bg-inherit flex w-full justify-between items-center mx-auto container`}>
